...
var playerRepository = {
    ...
    load() {
        ...
        if (this.playerInfo.payload) {
            ...
            systemRepository.getSongUrl(this.playerInfo.payload).then(url => {
    ...
    setPlayerInfo(id: number) {
        ...
        systemRepository.getSongsDetail([id]).then(res => {
       ...
       * 更改播放器状态
       */
    setPlayerStatus(args: { currentTime?: number,duration?: number,paused?: boolean,mode?: number}) {
